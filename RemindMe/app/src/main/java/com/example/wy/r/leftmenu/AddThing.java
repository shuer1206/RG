...
public class AddThing extends AppCompatActivity {
    ...
    public TextView data=null;  //aaaaaa
    public Date temp = new Date(System.currentTimeMillis());  //aaaaaa
    public static SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");//aaaaa
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data=(TextView)findViewById(R.id.thing_data); ///aaaaaa
        data.setText(format.format(temp));  //aaaaa
